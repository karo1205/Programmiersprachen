...
/**
 * Gets the two topmost elements of the stack and pushes a truth value onto it depending whether the second operand is bigger than the first  
 * 
 * @package   proglang.java.calculator.operator
 * @author    Robert Kapeller <rkapeller@gmail.com>
 * @copyright 2013 Robert Kapeller
 */
public class BiggerThanOperator implements ICalcOperator {
